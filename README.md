...
* **🤖 Asistente de Inicio:** Nueva pantalla de bienvenida interactiva para guiar a los nuevos usuarios.
* **📱 Interfaz Refinada:** Nuevos íconos SVG minimalistas, animaciones fluidas y notificaciones (Toasts) integradas.
...
2. Descarga la versión más reciente (`Setup_OrgPro.exe`).
